<nav class="navbar navbar-expand-lg navbar-light  px-lg-4 py-4">
    <div class="container">
        <div class="navbar-brand" href="#">

            <div class="d-flex header__heading">
                <div>
                ...
                <div>
                    <h2 class="title">PURO SAZÓN</h2>
                    <h5 class="subtitle">Recetario en Español</h5>
                </div>
            </div>
        </div>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        <a href="{{ route('home') }}" class="dropdown-item"> Tus recetas</a>
